...
CREATE UNIQUE INDEX IF NOT EXISTS ux_participants_session_account ON public.participants (session_id, account_id)
WHERE account_id IS NOT NULL;
CREATE UNIQUE INDEX IF NOT EXISTS ux_participants_session_guest_token ON public.participants (session_id, guest_rejoin_token_hash)
WHERE guest_rejoin_token_hash IS NOT NULL;
ALTER TABLE public.participants
