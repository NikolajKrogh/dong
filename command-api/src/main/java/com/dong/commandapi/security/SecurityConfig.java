...
/**
 * Stateless security. Public: OpenAPI docs + actuator health/metrics.
 * Protected: everything under {@code /v1/**}.
 *
 * <p>Filter placement: {@code SupabaseJwtFilter} is positioned just before
