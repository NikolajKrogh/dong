/**
 * League endpoint descriptor.
 * @description Represents a league code + display name (and optional category) used for ESPN API lookups.
 */
...
/**
 * League category labels.
 * @description Ordered list of high level geographic/grouping categories used for UI tabs.
 */
 ...
 * @description Minimal default subset of leagues preloaded in some flows.
 */
...
/**
 * Full available leagues list.
 * @description Extended catalogue of supported league endpoints grouped by category.
 */
export const AVAILABLE_LEAGUES: LeagueEndpoint[] = [
  ...
  {
    code: "bra.copa_do_brazil",
    name: "Copa do Brasil",
    category: "South America",
  },
  {
    code: "bra.camp.gaucho",
    name: "Brazilian Campeonato Gaucho",
    category: "South America",
  },
  {
    code: "bra.camp.paulista",
    name: "Brazilian Campeonato Paulista",
    category: "South America",
  },
  {
    code: "bra.camp.carioca",
    name: "Brazilian Campeonato Carioca",
    category: "South America",
  },
  {
    code: "bra.camp.mineiro",
  ...
  {
    code: "concacaf.womens.championship",
