...
- [ ] T005 [P] Implement authentication/authorization and policy validation framework
- [ ] T006 [P] Setup API routing, command boundaries, and middleware structure
- [ ] T007 Create base models/entities that all stories depend on
- [ ] T008 Configure error handling, logging, and observability infrastructure
- [ ] T009 Define idempotency, event-persistence, and environment configuration strategy
